 ...
 * <p>
 * Used mainly to annotate {@link java.util.Map} fields, indicates the field
 * should have its key parsed whenever reading the document from Solr and
 * formatted whenever being written to Solr based on wildcard field name defined
 * for it.
 * <p>
 * Example:
 * <p>
