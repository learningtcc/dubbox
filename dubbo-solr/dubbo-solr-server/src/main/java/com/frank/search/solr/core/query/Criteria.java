...
public class Criteria extends Node {
	...
	/**
	 * Crates new {@link Criteria.Predicate} without any wildcards. Strings with
	 * blanks will be escaped {@code "string\ with\ blank"}
	 *
	 * @param o
	 * @return
	 */
	...
	/**
	 * Crates new {@link Criteria.Predicate} without any wildcards for each
	 * entry
	 *
	 * @param values
	 * @return
	...
	/**
	 * Creates new {@link Criteria.Predicate} without any wildcards for each
	 * entry
	 *
	 * @param values
	 * @return
	...
	/**
	 * Crates new {@link Criteria.Predicate} for {@code null} values
	 *
	 * @return
	 */
	...
	/**
	 * Crates new {@link Criteria.Predicate} with leading and trailing wildcards
	 * <br/>
	 * <strong>NOTE: </strong>mind your schema as leading wildcards may not be
	 * supported and/or execution might be slow. <strong>NOTE: </strong>Strings
	 * will not be automatically split on whitespace.
	 *
	 * @param s
	 * @return
	 * @throws org.springframework.dao.InvalidDataAccessApiUsageException
	 *             for strings with whitespace
	 */
	...
	/**
	 * Crates new {@link Criteria.Predicate} with trailing wildcard <br/>
	 * <strong>NOTE: </strong>Strings will not be automatically split on
	 * whitespace.
	 *
	 * @param s
	 * @return
	...
	/**
	 * Crates new {@link Criteria.Predicate} with trailing wildcard for each
	 * entry
	 *
	 * @param values
	 * @return
	...
	/**
	 * Crates new {@link Criteria.Predicate} with leading wildcard <br />
	 * <strong>NOTE: </strong>mind your schema and execution times as leading
	 * wildcards may not be supported. <strong>NOTE: </strong>Strings will not
	 * be automatically split on whitespace.
	 *
	 * @param s
	 * @return
	 * @throws org.springframework.dao.InvalidDataAccessApiUsageException
	...
	/**
	 * Crates new {@link Criteria.Predicate} with leading wildcard for each
	 * entry<br />
	 * <strong>NOTE: </strong>mind your schema and execution times as leading
	...
	/**
	 * Crates new {@link Criteria.Predicate} with trailing {@code ~}
	 *
	 * @param s
	 * @return
	 */
	...
	/**
	 * Crates new {@link Criteria.Predicate} allowing native solr expressions
	 *
	 * @param s
	 * @return
	 */
	...
	/**
	 * Crates new {@link Criteria.Predicate} for
	 * {@code RANGE [lowerBound TO upperBound]}
	 *
	 * @param lowerBound
	 * @param upperBound
	 * @return
	 ...
	 * @return
	 */
	public Criteria between(Object lowerBound, Object upperBound, boolean includeLowerBound,
	...
	/**
	 * Crates new {@link Criteria.Predicate} for {@code RANGE [* TO upperBound]}
	 *
	 * @param upperBound
	 * @return
	 */
	...
	/**
	 * Crates new {@link Criteria.Predicate} for {@code RANGE [lowerBound TO *]}
	 *
	 * @param lowerBound
	 * @return
	 */
	...
	/**
	 * Crates new {@link Criteria.Predicate} for multiple values
	 * {@code (arg0 arg1 arg2 ...)}
	 *
	 * @param values
	 * @return
	 ...
	 *
	 * @param location
	 *            {@link org.springframework.data.geo.Point} in degrees
	 * @param distance
	 * @return
	 */
	public Criteria within(Point location, Distance distance) {
		...
		predicates.add(new Predicate(OperationKey.WITHIN,
				new Object[] { location, distance != null ? distance : new Distance(0) }));
		return this;
	}
	...
	/**
	 * Creates new {@link Criteria.Predicate} for {@code !bbox} for a specified
	 * distance. The difference between this and {@code within} is this is
	...
	public Criteria near(Point location, Distance distance) {
		...
		predicates.add(new Predicate(OperationKey.NEAR,
				new Object[] { location, distance != null ? distance : new Distance(0) }));
		return this;
	}
	...
	/**
	 * Creates {@link Criteria.Predicate} for given {@link Function}.
	 *
	 * @param function
	 *            must not be null
	 * @return
	...
	/**
	 * @return unmodifiable set of all {@link Criteria.Predicate}
	 */
	...
	public enum OperationKey {
		EQUALS("$equals"), CONTAINS("$contains"), STARTS_WITH("$startsWith"), ENDS_WITH("$endsWith"), EXPRESSION(
				"$expression"), BETWEEN("$between"), NEAR(
						"$near"), WITHIN("$within"), FUZZY("$fuzzy"), SLOPPY("$sloppy"), FUNCTION("$function");
	...
	/**
	 * Explicitly connect {@link Criteria} with another one allows to create
	 * explicit bracketing.
	 * 
	 * @since 1.4
	 * @return
