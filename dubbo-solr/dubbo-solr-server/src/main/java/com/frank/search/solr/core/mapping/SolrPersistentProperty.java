...
public interface SolrPersistentProperty extends PersistentProperty<SolrPersistentProperty> {
	...
	/**
	 * Returns whether the property is a <em>potential</em> score property of the owning {@link org.springframework.data.mapping.PersistentEntity}. This
	 * method is mainly used by {@link org.springframework.data.mapping.PersistentEntity} implementation to discover score property candidates on
	 * {@link org.springframework.data.mapping.PersistentEntity} creation you should rather call
	 * {@link org.springframework.data.mapping.PersistentEntity#isScoreProperty(org.springframework.data.mapping.PersistentProperty)} to determine whether the current property is the score
	 * property of that {@link org.springframework.data.mapping.PersistentEntity} under consideration.
	 * 
	 * @return
	 * @since 1.4
	 */
