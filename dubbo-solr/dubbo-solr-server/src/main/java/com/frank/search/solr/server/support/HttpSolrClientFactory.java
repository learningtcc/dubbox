...
/**
 * The {@link HttpSolrClientFactory} replaces HttpSolrServerFactory from version
 * 1.x and configures an
 * {@link org.apache.solr.client.solrj.impl.HttpSolrClient} to work with the
 * provided core. If provided Credentials eg. (@link
 * UsernamePasswordCredentials} and AuthPolicy (eg. BASIC, DIGEST,...) will be
 * applied to the underlying HttpClient.
 *
...
public class HttpSolrClientFactory extends SolrClientFactoryBase {
	...
	/**
	 * returns the reference {@link org.apache.solr.client.solrj.SolrClient}
	 * 
