...
public class CurrencyFunction extends AbstractFunction {
	...
	/**
	 * Create new {@link CurrencyFunction} representing
	 * {@code currency(fieldname)}
	 *
	 * @param fieldname
	 * @return
	 */
	...
	/**
	 * Create new {@link CurrencyFunction} using ISO-4217 currencyCode
	 * representing {@code currency(fiel.getName(),currencyCode)}
	 *
	 * @param field
	 * @param currencyCode
	 * @return
	...
	/**
	 * Create new {@link CurrencyFunction} using ISO-4217 currencyCode
	 * representing {@code currency(fieldname,currencyCode)}
	 * 
	 * @param fieldname
	 * @param currencyCode
	 * @return
