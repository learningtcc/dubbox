...
public @interface Facet {
	...
	/**
	 * {@code facet.mincount} minimum number of hits for result to be included
	 * in response
	 * 
	 * @return
	 */
	...
	/**
	 * {@code facet.pivot.mincount} minimum number of hits for result to be
	 * included in pivot response
	 * 
	 * @return
	 */
