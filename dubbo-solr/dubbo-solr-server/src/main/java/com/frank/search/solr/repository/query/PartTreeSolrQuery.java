...
public class PartTreeSolrQuery extends AbstractSolrQuery {
	...
	/**
	 * @see org.springframework.data.repository.query.parser.PartTree#isCountProjection()
	 * @since 1.2
	 */
	...
	/**
	 * @see org.springframework.data.repository.query.parser.PartTree#isDelete()
	 * @since 1.2
	 */
	@Override
	...
	/**
	 * @see org.springframework.data.repository.query.parser.PartTree#isLimiting()
	 * @since 1.3
	 */
	@Override
