...
public class SimpleQuery extends AbstractQuery implements Query, FilterQuery {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.springframework.data.solr.core.query.Query#setStatsOptions(org.
	 * springframework.data.solr.core.query.StatsOptions)
	 */
	@SuppressWarnings("unchecked")
	@Override
	...
	/**
	 * @return true if current operator does not equal
	 *         {@link Query.Operator#NONE}
	 */
