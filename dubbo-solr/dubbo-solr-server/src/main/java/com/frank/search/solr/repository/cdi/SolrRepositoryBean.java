 ...
 */
package com.frank.search.solr.repository.cdi;

import com.frank.search.solr.core.SolrOperations;
import com.frank.search.solr.repository.support.SolrRepositoryFactory;
...
/**
 * Uses {@link org.springframework.data.repository.cdi.CdiRepositoryBean} to
 * create {@link SolrRepository} instances.
 *
...
public class SolrRepositoryBean<T> extends CdiRepositoryBean<T> {
	 ...
	 *            must not be {@literal null}.
	 * @param detector
	 *            detector for the custom
	 *            {@link org.springframework.data.repository.Repository}
	 *            implementations
	 *            {@link org.springframework.data.repository.config.CustomRepositoryImplementationDetector}
	 *            , can be {@literal null}.
	 */
	 ...
	 * 
	 * @see
	 * org.springframework.data.repository.cdi.CdiRepositoryBean#create(javax.
	 * enterprise.context.spi.CreationalContext, java.lang.Class,
	 * java.lang.Object)
	 */
	@Override
