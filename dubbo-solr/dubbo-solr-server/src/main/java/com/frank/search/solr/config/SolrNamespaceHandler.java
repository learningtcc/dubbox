...
import com.frank.search.solr.repository.config.SolrRepositoryConfigExtension;
import com.frank.search.solr.server.config.EmbeddedSolrServerBeanDefinitionParser;
import com.frank.search.solr.server.config.HttpSolrClientBeanDefinitionParser;
 ...
 * to register parser for {@code <solr:repositories />}, {@code 
 * <solr:embedded-solr-server solrHome="path/to/solr/home/directory" />}
 * elements.
 * 
