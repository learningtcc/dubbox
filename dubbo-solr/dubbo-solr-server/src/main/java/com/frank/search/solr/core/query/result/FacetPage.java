...
import com.frank.search.solr.core.query.PivotField;
...
/**
 * FacetPage holds a page for each field targeted by the facet query as well as
 * the page values returned by facet.query
 * 
 * @param <T>
