...
import com.frank.search.solr.core.query.UpdateField;
import com.frank.search.solr.core.query.ValueHoldingField;
import com.frank.search.solr.core.query.Update;
...
/**
 * Offers classes that can convert from SolrDocument to any Object and vice
 * versa using the solrj DocumentObjectBinder
 * 
...
final class SolrjConverters {
	...
	/**
	 * Converts any {@link Update} to
	 * {@link org.apache.solr.common.SolrInputDocument} for atomic update.
	 *
	 * @author Christoph Strobl
	 *
	 */
	...
	/**
	 * Convert any {@link org.apache.solr.common.SolrDocument} to object of
	 * given {@link Class} using
