...
public class SolrMappingEventPublisher implements ApplicationEventPublisher {
	...
	static final boolean SPRING_42_PAYLOAD_APPLICATION_EVENT_PRESENT = ClassUtils
			.isPresent(SPRING_42_PAYLOAD_APPLICATION_EVENT_CLASS_NAME, null);
	 ...
	 * 
	 * @see
	 * org.springframework.context.ApplicationEventPublisher#publishEvent(org.
	 ...
	 * 
	 * @see
	 * org.springframework.context.ApplicationEventPublisher#publishEvent(java.
	 * lang.Object)
	 */
