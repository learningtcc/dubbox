...
import com.frank.search.solr.core.mapping.SolrSimpleTypes;
 ...
 * {@link org.springframework.core.convert.converter.Converter} that can be used
 * for mapping objects to (
 * {@link org.springframework.data.convert.WritingConverter}) and from (
 * {@link org.springframework.data.convert.ReadingConverter}) solr
 * representation.
 *
...
public class CustomConversions {
	...
	private ConcurrentMap<ConvertiblePair, Class<?>> cache = new ConcurrentHashMap<ConvertiblePair, Class<?>>(36, 0.9f,
			1);
	...
	/**
	 * ConvertibleContext is a holder for
	 * {@link org.springframework.core.convert.converter.GenericConverter.ConvertiblePair}
	...
	static class ConvertibleContext {
		...
		/**
		 * Create new instance wrapping source/target into
		 * {@link org.springframework.core.convert.converter.GenericConverter.ConvertiblePair}
		 *
		 * @param source
		 * @param target
