...
/**
 * {@link DelegatingCursor} is a base {@link Cursor} implementation that
 * temporarily holds data fetched in one run and delegates iteration.
 *
...
public abstract class DelegatingCursor<T> implements Cursor<T> {
	 ...
	 * 
	 * @see
	 * org.springframework.data.solr.core.query.result.Cursor#getCursorMark()
	 */
	@Override
	...
	/**
	 * {@link DelegatingCursor.PartialResult} provided by a round trip to
	 * SolrClient loading data for an iteration. Also holds the cursor mark to
	 * use next.
	 * 
	 * @author Christoph Strobl
	 * @param <T>
