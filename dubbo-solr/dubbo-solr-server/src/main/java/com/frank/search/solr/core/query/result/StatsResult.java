...
public interface StatsResult {
	...
	/**
	 * @return minimum value as {@link java.util.Date}, {@code null} will be returned when not {@link java.util.Date}
	 */
	Date getMinAsDate();
	...
	/**
	 * @return maximum value as {@link java.util.Date}, {@code null} will be returned when not {@link java.util.Date}
	 */
	Date getMaxAsDate();
