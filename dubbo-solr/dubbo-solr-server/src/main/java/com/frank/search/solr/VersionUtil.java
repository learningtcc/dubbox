 ...
 */
package com.frank.search.solr;

import org.springframework.util.ClassUtils;

/**
 * Version util uses
 * {@link org.springframework.util.ClassUtils#isPresent(String)} to determine
 * presence of certain classes that are unique to some libraries, which allows
 * to en-/disable some of the features in eg.
...
public final class VersionUtil {
	...
	/**
	 * @return true if
	 *         {@link org.apache.solr.client.solrj.impl.CommonsHttpSolrServer}
	 *         (removed in solr 4.0.0) is in path
	 */
	...
	/**
	 * @return true if {@link org.apache.solr.client.solrj.impl.CloudSolrServer}
	 *         (introduced in solr 4.0.0) is in path
	 */
