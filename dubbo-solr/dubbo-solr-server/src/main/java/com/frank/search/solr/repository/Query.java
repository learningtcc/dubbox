 ...
 */
package com.frank.search.solr.repository;
...
public @interface Query {
	...
	/**
	 * Solr QueryString to be used when executing query. May contain
	 * placeholders eg. {@code ?1}
	 * 
	 * @return
	 */
	 ...
	 * @return
	 */
	com.frank.search.solr.core.query.Query.Operator defaultOperator() default com.frank.search.solr.core.query.Query.Operator.NONE;
	...
	/**
	 * The time in milliseconds allowed for a search to finish. Values <= 0 mean
	 * no time restriction.
	 * 
	 * @return
	 */
