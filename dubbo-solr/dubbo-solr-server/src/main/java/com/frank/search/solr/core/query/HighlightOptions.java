...
/**
 * Empty Options indicate to set {@code hl=true}. As long as there are no fields
 * defined {@code *} will be used. Some options like
 * {@see HighlightOptions#setFormatter(String)} can be set directly. Any option
 * can be set via
