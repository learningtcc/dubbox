...
import com.frank.search.solr.core.query.SimpleField;
import com.frank.search.solr.core.query.Field;
...
/**
 * Highlight result entry holding reference to domain object (
 * {@link #getEntity()) as well as the highlights
 * 
...
public class HighlightEntry<T> {
	...
	/**
	 * Highlight holds reference to the field highlighting was applied to, as
	 * well as the snipplets
	 * 
	 * @author Christoph Strobl
	 */
