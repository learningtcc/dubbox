...
public class StatsOptions {
	...
	/**
	 * @param field
	 * @return true if a distinct calculation shall be done selectively to the
	 *         given field.
	 */
	...
	/**
	 * Set of options available to get field's statistics having a field as
	 * context.
	 * 
	 * @author Francisco Spaeth
	 * @sice 1.4
	...
	public class FieldStatsOptions extends StatsOptions {
		...
		/**
		 * Adds a selective facet over stats result of the field being
		 * configured.
		 * 
		 * @param field
		 * @return
