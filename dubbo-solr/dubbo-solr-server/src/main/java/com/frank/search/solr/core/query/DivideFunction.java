...
public class DivideFunction extends AbstractFunction {
	...
	/**
	 * creates new {@link DivideFunction.Builder} for dividing value in field
	 * with given name
	 *
	 * @param field
	 *            must not be null
	...
	/**
	 * creates new {@link DivideFunction.Builder} for dividing given value
	 *
	 * @param dividend
	 * @return
	 */
	...
	/**
	 * creates new {@link DivideFunction.Builder} for dividing value calculated
	 * by given {@link Function}
	 * 
	 * @param dividend
	 * @return
	 */
