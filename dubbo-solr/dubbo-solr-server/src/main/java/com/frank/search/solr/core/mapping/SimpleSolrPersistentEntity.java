 ...
 */
package com.frank.search.solr.core.mapping;

import com.frank.search.solr.repository.Score;
...
/**
 * Solr specific {@link org.springframework.data.mapping.PersistentEntity}
 * implementation holding eg. name of solr core.
 * 
 * @param <T>
...
public class SimpleSolrPersistentEntity<T> extends BasicPersistentEntity<T, SolrPersistentProperty>
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.springframework.data.solr.core.mapping.SolrPersistentEntity#
	 * getSolrCoreName()
	 */
	@Override
	 ...
	 * 
	 * @see
	 * org.springframework.data.solr.core.mapping.SolrPersistentEntity#isBoosted
	 * ()
	 */
	@Override
	 ...
	 * 
	 * @see
	 * org.springframework.data.solr.core.mapping.SolrPersistentEntity#getBoost(
	 * )
	 */
	@Override
	...
	/**
	 * Handler to inspect {@link SolrPersistentProperty} instances and check
	 * that max one can be mapped as {@link Score} property.
	 * 
	...
	private static class ScoreFieldUniquenessHandler implements PropertyHandler<SolrPersistentProperty> {
		 ...
		 * doWithPersistentProperty(org.springframework.data.mapping.
		 * PersistentProperty)
		 */
		...
		public void doWithPersistentProperty(SolrPersistentProperty property) {
			...
			if (property.isDynamicProperty()) {
				...
				if (!property.containsWildcard()) {
					throw new MappingException(String.format(DYNAMIC_PROPERTY_NOT_CONTAINING_WILDCARD,
