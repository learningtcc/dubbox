...
/**
 * Set of options that could be set for a {@link Query} in order to have grouped
 * results.
 * 
...
public class GroupOptions {
	...
	/**
	 * Defines whether or not the first field group result shall be used as main
	 * result.
	 * 
	 * @param groupMain
	 * @return
	...
	/**
	 * @return whether or not the first field group result shall be used as main
	 *         result.
	 */
