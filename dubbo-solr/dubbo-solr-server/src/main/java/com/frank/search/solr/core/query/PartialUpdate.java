...
/**
 * Implementation of {@link Update} to be used when performing atomic updates
 * against solr. <br />
 * Update can directly be saved via
 * {@link org.springframework.data.solr.core.SolrOperations#saveBean(Object)}
 * 
 * 
...
public class PartialUpdate implements Update {
	...
	/**
	 * Add field with given name and value to the fields to be updated. Default
	 * {@link UpateAction} will be {@link UpateAction.SET}.
	 * 
	 * @param fieldName
	 * @param value
	 */
	...
	/**
	 * Add field with given name and value using {@link UpateAction.ADD} to the
	...
	/**
	 * Add field with given name and value using {@link UpateAction.SET} to the
	 * fields to be updated.
	 * 
	 * @param fieldName
	 * @param value
	...
	/**
	 * Add field with given name and value using {@link UpateAction.INC} to the
	 * fields to be updated.
	 * 
	 * @param fieldName
	 * @param value
	...
	/**
	 * set {@code _version_} of document to apply update to. Use null to skip
	 * version check in solr.
	 * 
