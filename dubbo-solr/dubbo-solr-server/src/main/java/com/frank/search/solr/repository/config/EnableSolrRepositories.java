 ...
 */
package com.frank.search.solr.repository.config;

import com.frank.search.solr.core.SolrTemplate;
import com.frank.search.solr.repository.support.SolrRepositoryFactoryBean;
...
/**
 * Annotation to enable Solr repositories. Will scan the package of the
...
public @interface EnableSolrRepositories {
	 ...
	 * {@code @EnableSolrRepositories("org.my.pkg")} instead of
	 * {@code @EnableSolrRpositories(basePackages="org.my.pkg")}.
	 */
	...
	/**
	 * Configures the name of the {@link SolrTemplate} bean definition to be
	 * used to create repositories discovered through this annotation. Defaults
	 * to {@code solrTemplate}.
	 * 
	 * @return
	 */
	...
	/**
	 * Configures the name of the {@link org.apache.solr.client.solrj} bean
	 * definition to be used for creating templates
	 * 
	 * @since 1.1
	 */
