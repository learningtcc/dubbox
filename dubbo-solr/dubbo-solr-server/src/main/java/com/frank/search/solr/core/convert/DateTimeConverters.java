...
/**
 * Converts a Date values into a solr readable String that can be directly used
 * within the {@code q} parameter. Note that Dates have to be UTC. <br/>
 * <code>
...
public final class DateTimeConverters {
	...
	private static final DateTimeFormatter FORMATTER_WITHOUT_MILLIS = ISODateTimeFormat.dateTimeNoMillis()
			.withZoneUTC();

	/**
	 * Converter used to parse {@link org.joda.time.DateTime} to {@link String}
	 * used for setting {@link org.apache.solr.client.solrj.SolrQuery} query
	 * string values
	 *
	 * @author Christoph Strobl
	 *
	...
	/**
	 * Reading {@link org.springframework.core.convert.converter.Converter}
	 * parses {@link java.util.Date} from
	 * {@link org.apache.solr.common.SolrDocument} to
	...
	/**
	 * Writing {@link org.springframework.core.convert.converter.Converter}
	 * converts {@link org.joda.time.DateTime} to {@link java.util.Date} so it
	 * can be used within {@link org.apache.solr.common.SolrInputDocument}
	 *
	 * @author Christoph Strobl
	 *
	 */
	...
	/**
	 * Converter used to parse {@link org.joda.time.LocalDateTime} to
	 * {@link String} used for setting
	...
	/**
	 * Writing {@link org.springframework.core.convert.converter.Converter}
	 * converts {@link org.joda.time.LocalDateTime} to {@link java.util.Date} so
	 * it can be used within {@link org.apache.solr.common.SolrInputDocument}
	 *
	 * @author Christoph Strobl
	 *
	 */
	...
	/**
	 * Converter used to parse {@link java.util.Date} to {@link String} used for
	 * setting {@link org.apache.solr.client.solrj.SolrQuery} query string
	 * values
	 * 
	 * @author Christoph Strobl
	 * 
